...
//        int[] digits = {9, 8, 7, 6, 5, 4, 3, 2, 1, 0};
        ...
        System.out.println(Arrays.toString(mySolution(digits)));
    }
    ...
    static int[] mySolution2(int[] digits) {
        long num = 0;
        ...
        int[] result = new int[Long.valueOf(++num).toString().length()];
        for (int i = result.length - 1; i >= 0; i--) {
            result[i] = (int) (num % 10);
            num = num / 10;
        }
